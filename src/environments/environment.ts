...
export const environment = {
    ...
    // ACCOUNTS_URL:   'https://localhost:8443/api/v0.1/accounts',
    // CARD_TYPES_URL: 'https://localhost:8443/api/v0.1/accountTypes',
    // CARDS_URL:      'https://localhost:8443/api/v0.1/cards',
    // LOAN_TYPES_URL: 'https://localhost:8444/api/v0.1/LoanTypes',
    // LOANS_URL:      'https://localhost:8444/loans',
};
