...
export const environment = {
    production: false,
    AUTH_URL:       'https://3.92.185.127:8443/login',
    ACCOUNTS_URL:   'https://3.92.185.127:8443/api/v0.1/accounts',
    CARD_TYPES_URL: 'https://3.92.185.127:8443/api/v0.1/accountTypes',
    CARDS_URL:      'https://3.92.185.127:8443/api/v0.1/cards',
    LOAN_TYPES_URL: 'https://3.92.185.127:8443/api/v0.1/LoanTypes',
    LOANS_URL:      'https://3.92.185.127:8443/api/v0.1/Loans',
